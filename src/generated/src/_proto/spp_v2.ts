...
export enum ComputeToDataResponseState {
  QUEUED = 0,
  IN_PROGRESS = 1,
  FINISHED = 2,
  UNRECOGNIZED = -1,
...
export function computeToDataResponseStateFromJSON(object: any): ComputeToDataResponseState {
  switch (object) {
    case 0:
    case "QUEUED":
      return ComputeToDataResponseState.QUEUED;
    case 1:
    case "IN_PROGRESS":
      return ComputeToDataResponseState.IN_PROGRESS;
    case 2:
    case "FINISHED":
      return ComputeToDataResponseState.FINISHED;
    case -1:
    case "UNRECOGNIZED":
    default:
      return ComputeToDataResponseState.UNRECOGNIZED;
  }
}

export function computeToDataResponseStateToJSON(object: ComputeToDataResponseState): string {
  switch (object) {
    case ComputeToDataResponseState.QUEUED:
      return "QUEUED";
    case ComputeToDataResponseState.IN_PROGRESS:
      return "IN_PROGRESS";
    case ComputeToDataResponseState.FINISHED:
      return "FINISHED";
    case ComputeToDataResponseState.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export interface AccessOfferingRequest_Offering {
  pontusxOffering?: PontusxAccessOffering | undefined;
  xfscOffering?: XfscAccessOffering | undefined;
}

export interface AccessOfferingResponse {
  did: string;
  accessUrl: string;
}

export interface XfscAccessOffering {
  did: string;
  issuer: string;
  name: string;
}
...
export interface PontusxAccessOffering_UserDataEntry {
  key: string;
  value: string;
}
...
export interface GetComputeToDataResultResponse {
  state: ComputeToDataResponseState;
  data: string;
}
...
export const CreateOfferingRequest: MessageFns<CreateOfferingRequest> = {
  encode(message: CreateOfferingRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.offerings) {
      CreateOfferingRequest_Offering.encode(v!, writer.uint32(82).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CreateOfferingRequest {
...
export const CreateOfferingRequest_Offering: MessageFns<CreateOfferingRequest_Offering> = {
  encode(message: CreateOfferingRequest_Offering, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pontusxOffering !== undefined) {
      PontusxOffering.encode(message.pontusxOffering, writer.uint32(10).fork()).join();
    }
    if (message.xfscOffering !== undefined) {
      XfscOffering.encode(message.xfscOffering, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CreateOfferingRequest_Offering {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const XfscOffering: MessageFns<XfscOffering> = {
  encode(message: XfscOffering, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.VP !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): XfscOffering {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBasePontusxOffering(): PontusxOffering {
  return { metadata: undefined, additionalInformation: undefined, services: [], credentials: undefined };
}

export const PontusxOffering: MessageFns<PontusxOffering> = {
  encode(message: PontusxOffering, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.metadata !== undefined) {
      Metadata.encode(message.metadata, writer.uint32(10).fork()).join();
    }
    if (message.additionalInformation !== undefined) {
      AdditionalInformation.encode(message.additionalInformation, writer.uint32(18).fork()).join();
    }
    for (const v of message.services) {
      Service.encode(v!, writer.uint32(26).fork()).join();
    }
    if (message.credentials !== undefined) {
      CredentialLists.encode(message.credentials, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): PontusxOffering {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.credentials = CredentialLists.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): PontusxOffering {
    return {
      ...
      credentials: isSet(object.credentials) ? CredentialLists.fromJSON(object.credentials) : undefined,
    };
  },
  ...
  toJSON(message: PontusxOffering): unknown {
    ...
    if (message.credentials !== undefined) {
      obj.credentials = CredentialLists.toJSON(message.credentials);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<PontusxOffering>, I>>(object: I): PontusxOffering {
    ...
    message.credentials = (object.credentials !== undefined && object.credentials !== null)
      ? CredentialLists.fromPartial(object.credentials)
      : undefined;
    return message;
  },
};
...
export const CreateOfferingResponse: MessageFns<CreateOfferingResponse> = {
  encode(message: CreateOfferingResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.id) {
      writer.uint32(10).string(v!);
    }
    if (message.DebugInformation !== undefined) {
      Struct.encode(Struct.wrap(message.DebugInformation), writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CreateOfferingResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateOfferingRequest: MessageFns<UpdateOfferingRequest> = {
  encode(message: UpdateOfferingRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.offerings) {
      UpdateOfferingRequest_UpdateOffering.encode(v!, writer.uint32(82).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UpdateOfferingRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateOfferingRequest_UpdateOffering: MessageFns<UpdateOfferingRequest_UpdateOffering> = {
  encode(message: UpdateOfferingRequest_UpdateOffering, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pontusxUpdateOffering !== undefined) {
      PontusxUpdateOffering.encode(message.pontusxUpdateOffering, writer.uint32(10).fork()).join();
    }
    if (message.xfscUpdateOffering !== undefined) {
      XfscUpdateOffering.encode(message.xfscUpdateOffering, writer.uint32(18).fork()).join();
    }
    if (message.publishInfo !== undefined) {
      PublishInfo.encode(message.publishInfo, writer.uint32(50).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UpdateOfferingRequest_UpdateOffering {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const XfscUpdateOffering: MessageFns<XfscUpdateOffering> = {
  encode(message: XfscUpdateOffering, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.hash !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): XfscUpdateOffering {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBasePontusxUpdateOffering(): PontusxUpdateOffering {
  return { did: "", metadata: undefined, additionalInformation: undefined, updateServices: [], credentials: undefined };
}

export const PontusxUpdateOffering: MessageFns<PontusxUpdateOffering> = {
  encode(message: PontusxUpdateOffering, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.did !== "") {
    ...
    if (message.additionalInformation !== undefined) {
      AdditionalInformation.encode(message.additionalInformation, writer.uint32(26).fork()).join();
    }
    for (const v of message.updateServices) {
      PontusxUpdateOffering_UpdateService.encode(v!, writer.uint32(34).fork()).join();
    }
    if (message.credentials !== undefined) {
      CredentialLists.encode(message.credentials, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): PontusxUpdateOffering {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PontusxUpdateOffering_UpdateService: MessageFns<PontusxUpdateOffering_UpdateService> = {
  encode(message: PontusxUpdateOffering_UpdateService, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PontusxUpdateOffering_UpdateService {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PublishInfo: MessageFns<PublishInfo> = {
  encode(message: PublishInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.source !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PublishInfo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateOfferingResponse: MessageFns<UpdateOfferingResponse> = {
  encode(message: UpdateOfferingResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.id) {
      writer.uint32(10).string(v!);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateOfferingResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateOfferingLifecycleRequest: MessageFns<UpdateOfferingLifecycleRequest> = {
  encode(message: UpdateOfferingLifecycleRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.offerings) {
      UpdateOfferingLifecycleRequest_UpdateOfferingLifecycle.encode(v!, writer.uint32(82).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UpdateOfferingLifecycleRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateOfferingLifecycleRequest_UpdateOfferingLifecycle: MessageFns<
...
> = {
  encode(
    ...
    if (message.pontusxUpdateOfferingLifecycle !== undefined) {
      PontusxUpdateOfferingLifecycle.encode(message.pontusxUpdateOfferingLifecycle, writer.uint32(10).fork()).join();
    }
    if (message.xfscUpdateOfferingLifecycle !== undefined) {
      XfscUpdateOfferingLifecycle.encode(message.xfscUpdateOfferingLifecycle, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UpdateOfferingLifecycleRequest_UpdateOfferingLifecycle {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PontusxUpdateOfferingLifecycle: MessageFns<PontusxUpdateOfferingLifecycle> = {
  encode(message: PontusxUpdateOfferingLifecycle, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.did !== "") {
      writer.uint32(10).string(message.did);
    }
    if (message.to !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PontusxUpdateOfferingLifecycle {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const XfscUpdateOfferingLifecycle: MessageFns<XfscUpdateOfferingLifecycle> = {
  encode(message: XfscUpdateOfferingLifecycle, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.hash !== "") {
      writer.uint32(10).string(message.hash);
    }
    if (message.to !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): XfscUpdateOfferingLifecycle {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateOfferingLifecycleResponse: MessageFns<UpdateOfferingLifecycleResponse> = {
  encode(message: UpdateOfferingLifecycleResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.id) {
      writer.uint32(10).string(v!);
    }
    if (message.DebugInformation !== undefined) {
      Struct.encode(Struct.wrap(message.DebugInformation), writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UpdateOfferingLifecycleResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetOfferingRequest: MessageFns<GetOfferingRequest> = {
  encode(message: GetOfferingRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.offerings) {
      GetOfferingRequest_Offering.encode(v!, writer.uint32(82).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetOfferingRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetOfferingRequest_Offering: MessageFns<GetOfferingRequest_Offering> = {
  encode(message: GetOfferingRequest_Offering, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pontusxOffering !== undefined) {
      PontusxGetOffering.encode(message.pontusxOffering, writer.uint32(10).fork()).join();
    }
    if (message.xfscOffering !== undefined) {
      XfscGetOffering.encode(message.xfscOffering, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetOfferingRequest_Offering {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetOfferingResponse: MessageFns<GetOfferingResponse> = {
  encode(message: GetOfferingResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.offerings) {
      writer.uint32(10).string(v!);
    }
    if (message.DebugInformation !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetOfferingResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const XfscGetOffering: MessageFns<XfscGetOffering> = {
  encode(message: XfscGetOffering, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.did !== "") {
      writer.uint32(10).string(message.did);
    }
    if (message.issuer !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): XfscGetOffering {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PontusxGetOffering: MessageFns<PontusxGetOffering> = {
  encode(message: PontusxGetOffering, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.did !== "") {
      writer.uint32(10).string(message.did);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PontusxGetOffering {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AccessOfferingRequest: MessageFns<AccessOfferingRequest> = {
  encode(message: AccessOfferingRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.offering !== undefined) {
      AccessOfferingRequest_Offering.encode(message.offering, writer.uint32(82).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AccessOfferingRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAccessOfferingRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 10: {
          ...
          message.offering = AccessOfferingRequest_Offering.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): AccessOfferingRequest {
    return { offering: isSet(object.offering) ? AccessOfferingRequest_Offering.fromJSON(object.offering) : undefined };
  },

  toJSON(message: AccessOfferingRequest): unknown {
    const obj: any = {};
    if (message.offering !== undefined) {
      obj.offering = AccessOfferingRequest_Offering.toJSON(message.offering);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<AccessOfferingRequest>, I>>(base?: I): AccessOfferingRequest {
    return AccessOfferingRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AccessOfferingRequest>, I>>(object: I): AccessOfferingRequest {
    const message = createBaseAccessOfferingRequest();
    message.offering = (object.offering !== undefined && object.offering !== null)
      ? AccessOfferingRequest_Offering.fromPartial(object.offering)
      : undefined;
    return message;
  },
};

function createBaseAccessOfferingRequest_Offering(): AccessOfferingRequest_Offering {
  return { pontusxOffering: undefined, xfscOffering: undefined };
}

export const AccessOfferingRequest_Offering: MessageFns<AccessOfferingRequest_Offering> = {
  encode(message: AccessOfferingRequest_Offering, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pontusxOffering !== undefined) {
      PontusxAccessOffering.encode(message.pontusxOffering, writer.uint32(10).fork()).join();
    }
    if (message.xfscOffering !== undefined) {
      XfscAccessOffering.encode(message.xfscOffering, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AccessOfferingRequest_Offering {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAccessOfferingRequest_Offering();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.pontusxOffering = PontusxAccessOffering.decode(reader, reader.uint32());
          continue;
        }
        case 2: {
          if (tag !== 18) {
          ...
          message.xfscOffering = XfscAccessOffering.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): AccessOfferingRequest_Offering {
    return {
      pontusxOffering: isSet(object.pontusxOffering)
        ? PontusxAccessOffering.fromJSON(object.pontusxOffering)
        : undefined,
      xfscOffering: isSet(object.xfscOffering) ? XfscAccessOffering.fromJSON(object.xfscOffering) : undefined,
    };
  },

  toJSON(message: AccessOfferingRequest_Offering): unknown {
    const obj: any = {};
    if (message.pontusxOffering !== undefined) {
      obj.pontusxOffering = PontusxAccessOffering.toJSON(message.pontusxOffering);
    }
    if (message.xfscOffering !== undefined) {
      obj.xfscOffering = XfscAccessOffering.toJSON(message.xfscOffering);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<AccessOfferingRequest_Offering>, I>>(base?: I): AccessOfferingRequest_Offering {
    return AccessOfferingRequest_Offering.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AccessOfferingRequest_Offering>, I>>(
    object: I,
  ): AccessOfferingRequest_Offering {
    const message = createBaseAccessOfferingRequest_Offering();
    message.pontusxOffering = (object.pontusxOffering !== undefined && object.pontusxOffering !== null)
      ? PontusxAccessOffering.fromPartial(object.pontusxOffering)
      : undefined;
    message.xfscOffering = (object.xfscOffering !== undefined && object.xfscOffering !== null)
      ? XfscAccessOffering.fromPartial(object.xfscOffering)
      : undefined;
    return message;
  },
};

function createBaseAccessOfferingResponse(): AccessOfferingResponse {
  return { did: "", accessUrl: "" };
}

export const AccessOfferingResponse: MessageFns<AccessOfferingResponse> = {
  encode(message: AccessOfferingResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.did !== "") {
      writer.uint32(10).string(message.did);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AccessOfferingResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAccessOfferingResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): AccessOfferingResponse {
    return {
      did: isSet(object.did) ? globalThis.String(object.did) : "",
  ...
  toJSON(message: AccessOfferingResponse): unknown {
    const obj: any = {};
    if (message.did !== "") {
      obj.did = message.did;
    }
  ...
  create<I extends Exact<DeepPartial<AccessOfferingResponse>, I>>(base?: I): AccessOfferingResponse {
    return AccessOfferingResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AccessOfferingResponse>, I>>(object: I): AccessOfferingResponse {
    const message = createBaseAccessOfferingResponse();
    message.did = object.did ?? "";
...
function createBaseXfscAccessOffering(): XfscAccessOffering {
  return { did: "", issuer: "", name: "" };
}

export const XfscAccessOffering: MessageFns<XfscAccessOffering> = {
  encode(message: XfscAccessOffering, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.did !== "") {
      writer.uint32(10).string(message.did);
    }
    if (message.issuer !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): XfscAccessOffering {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseXfscAccessOffering();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): XfscAccessOffering {
    return {
      did: isSet(object.did) ? globalThis.String(object.did) : "",
      issuer: isSet(object.issuer) ? globalThis.String(object.issuer) : "",
      name: isSet(object.name) ? globalThis.String(object.name) : "",
  ...
  toJSON(message: XfscAccessOffering): unknown {
    const obj: any = {};
    if (message.did !== "") {
      obj.did = message.did;
    }
  ...
  create<I extends Exact<DeepPartial<XfscAccessOffering>, I>>(base?: I): XfscAccessOffering {
    return XfscAccessOffering.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<XfscAccessOffering>, I>>(object: I): XfscAccessOffering {
    const message = createBaseXfscAccessOffering();
    message.did = object.did ?? "";
    message.issuer = object.issuer ?? "";
    message.name = object.name ?? "";
...
export const PontusxAccessOffering: MessageFns<PontusxAccessOffering> = {
  encode(message: PontusxAccessOffering, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.did !== "") {
      writer.uint32(10).string(message.did);
    }
    ...
    Object.entries(message.userData).forEach(([key, value]) => {
      PontusxAccessOffering_UserDataEntry.encode({ key: key as any, value }, writer.uint32(34).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): PontusxAccessOffering {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          const entry4 = PontusxAccessOffering_UserDataEntry.decode(reader, reader.uint32());
  ...
  toJSON(message: PontusxAccessOffering): unknown {
    const obj: any = {};
    if (message.did !== "") {
      obj.did = message.did;
    }
  ...
  create<I extends Exact<DeepPartial<PontusxAccessOffering>, I>>(base?: I): PontusxAccessOffering {
    return PontusxAccessOffering.fromPartial(base ?? ({} as any));
  },
...
function createBasePontusxAccessOffering_UserDataEntry(): PontusxAccessOffering_UserDataEntry {
  return { key: "", value: "" };
}

export const PontusxAccessOffering_UserDataEntry: MessageFns<PontusxAccessOffering_UserDataEntry> = {
  encode(message: PontusxAccessOffering_UserDataEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PontusxAccessOffering_UserDataEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePontusxAccessOffering_UserDataEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): PontusxAccessOffering_UserDataEntry {
    return {
  ...
  toJSON(message: PontusxAccessOffering_UserDataEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create<I extends Exact<DeepPartial<PontusxAccessOffering_UserDataEntry>, I>>(
    base?: I,
  ): PontusxAccessOffering_UserDataEntry {
    return PontusxAccessOffering_UserDataEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<PontusxAccessOffering_UserDataEntry>, I>>(
    object: I,
  ): PontusxAccessOffering_UserDataEntry {
    const message = createBasePontusxAccessOffering_UserDataEntry();
...
export const CreateComputeToDataRequest: MessageFns<CreateComputeToDataRequest> = {
  encode(message: CreateComputeToDataRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.did !== "") {
      writer.uint32(10).string(message.did);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateComputeToDataRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ComputeToDataResponse: MessageFns<ComputeToDataResponse> = {
  encode(message: ComputeToDataResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ComputeToDataResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseCreateComputeToDataResultRequest(): CreateComputeToDataResultRequest {
  return { jobId: "", jobIndex: undefined, computeToDataReturnType: 0 };
}

export const CreateComputeToDataResultRequest: MessageFns<CreateComputeToDataResultRequest> = {
  encode(message: CreateComputeToDataResultRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.jobId !== "") {
      writer.uint32(10).string(message.jobId);
    }
    if (message.jobIndex !== undefined) {
      writer.uint32(24).int32(message.jobIndex);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateComputeToDataResultRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): CreateComputeToDataResultRequest {
    return {
      ...
      jobIndex: isSet(object.jobIndex) ? globalThis.Number(object.jobIndex) : undefined,
  ...
  toJSON(message: CreateComputeToDataResultRequest): unknown {
    ...
    if (message.jobIndex !== undefined) {
      obj.jobIndex = Math.round(message.jobIndex);
    }
    if (message.computeToDataReturnType !== 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<CreateComputeToDataResultRequest>, I>>(
    ...
    message.jobIndex = object.jobIndex ?? undefined;
...
export const GetComputeToDataResultResponse: MessageFns<GetComputeToDataResultResponse> = {
  encode(message: GetComputeToDataResultResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.state !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetComputeToDataResultResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): GetComputeToDataResultResponse {
    return {
      state: isSet(object.state) ? computeToDataResponseStateFromJSON(object.state) : 0,
      data: isSet(object.data) ? globalThis.String(object.data) : "",
    };
  },
  ...
  toJSON(message: GetComputeToDataResultResponse): unknown {
    const obj: any = {};
    if (message.state !== 0) {
      obj.state = computeToDataResponseStateToJSON(message.state);
    }
    if (message.data !== "") {
      obj.data = message.data;
    }
...
export const Metadata: MessageFns<Metadata> = {
  encode(message: Metadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.algorithm !== undefined) {
      AlgorithmMetadata.encode(message.algorithm, writer.uint32(58).fork()).join();
    }
    return writer;
  },
...
export const AlgorithmMetadata: MessageFns<AlgorithmMetadata> = {
  encode(message: AlgorithmMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.consumerParameters) {
      ConsumerParameter.encode(v!, writer.uint32(26).fork()).join();
    }
    if (message.container !== undefined) {
      Container.encode(message.container, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AlgorithmMetadata {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Service: MessageFns<Service> = {
  encode(message: Service, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.pricing !== undefined) {
      Pricing.encode(message.pricing, writer.uint32(82).fork()).join();
    }
    for (const v of message.files) {
      Files.encode(v!, writer.uint32(34).fork()).join();
    }
    ...
    if (message.computeOptions !== undefined) {
      ComputeOptions.encode(message.computeOptions, writer.uint32(66).fork()).join();
    }
    for (const v of message.consumerParameters) {
      ConsumerParameter.encode(v!, writer.uint32(74).fork()).join();
    }
    return writer;
  },
...
export const Files: MessageFns<Files> = {
  encode(message: Files, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    Object.entries(message.headers).forEach(([key, value]) => {
      Files_HeadersEntry.encode({ key: key as any, value }, writer.uint32(50).fork()).join();
    });
    return writer;
  },
...
export const Files_HeadersEntry: MessageFns<Files_HeadersEntry> = {
  encode(message: Files_HeadersEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Files_HeadersEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ComputeOptions: MessageFns<ComputeOptions> = {
  encode(message: ComputeOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.trustedAlgorithms) {
      TrustedAlgorihm.encode(v!, writer.uint32(26).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ComputeOptions {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TrustedAlgorihm: MessageFns<TrustedAlgorihm> = {
  encode(message: TrustedAlgorihm, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.did !== "") {
      writer.uint32(10).string(message.did);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TrustedAlgorihm {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AdditionalInformation: MessageFns<AdditionalInformation> = {
  encode(message: AdditionalInformation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.termsAndConditions !== false) {
      writer.uint32(32).bool(message.termsAndConditions);
    }
    if (message.gaiaXInformation !== undefined) {
      gaiaX.encode(message.gaiaXInformation, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AdditionalInformation {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const gaiaX: MessageFns<gaiaX> = {
  encode(message: gaiaX, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.containsPII !== false) {
      writer.uint32(8).bool(message.containsPII);
    }
    for (const v of message.termsAndConditions) {
      Terms.encode(v!, writer.uint32(18).fork()).join();
    }
    if (message.serviceSD !== undefined) {
      gaiaX_ServiceSelfDescription.encode(message.serviceSD, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): gaiaX {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const gaiaX_ServiceSelfDescription: MessageFns<gaiaX_ServiceSelfDescription> = {
  encode(message: gaiaX_ServiceSelfDescription, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.url !== "") {
      writer.uint32(10).string(message.url);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): gaiaX_ServiceSelfDescription {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Terms: MessageFns<Terms> = {
  encode(message: Terms, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.url !== "") {
      writer.uint32(10).string(message.url);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Terms {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ConsumerParameter: MessageFns<ConsumerParameter> = {
  encode(message: ConsumerParameter, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.type !== "") {
    ...
    for (const v of message.options) {
      Struct.encode(Struct.wrap(v!), writer.uint32(82).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ConsumerParameter {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseCredentialLists(): CredentialLists {
  return { allow: [], deny: [] };
}

export const CredentialLists: MessageFns<CredentialLists> = {
  encode(message: CredentialLists, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CredentialLists {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCredentialLists();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CredentialLists {
    return {
  ...
  toJSON(message: CredentialLists): unknown {
    const obj: any = {};
  ...
  create<I extends Exact<DeepPartial<CredentialLists>, I>>(base?: I): CredentialLists {
    return CredentialLists.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CredentialLists>, I>>(object: I): CredentialLists {
    const message = createBaseCredentialLists();
...
export class serviceofferingPublisherClientImpl implements serviceofferingPublisher {
  ...
  CreateOffering(request: CreateOfferingRequest): Promise<CreateOfferingResponse> {
    ...
    return promise.then((data) => CreateOfferingResponse.decode(new BinaryReader(data)));
  }

  UpdateOffering(request: UpdateOfferingRequest): Promise<UpdateOfferingResponse> {
    const data = UpdateOfferingRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "UpdateOffering", data);
    return promise.then((data) => UpdateOfferingResponse.decode(new BinaryReader(data)));
  }
  ...
  UpdateOfferingLifecycle(request: UpdateOfferingLifecycleRequest): Promise<UpdateOfferingLifecycleResponse> {
    ...
    return promise.then((data) => UpdateOfferingLifecycleResponse.decode(new BinaryReader(data)));
  }
  ...
  AccessOffering(request: AccessOfferingRequest): Promise<AccessOfferingResponse> {
    const data = AccessOfferingRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "AccessOffering", data);
    return promise.then((data) => AccessOfferingResponse.decode(new BinaryReader(data)));
  }
  ...
  RunComputeToDataJob(request: CreateComputeToDataRequest): Promise<ComputeToDataResponse> {
    ...
    return promise.then((data) => ComputeToDataResponse.decode(new BinaryReader(data)));
  }
  ...
  GetComputeToDataResult(request: CreateComputeToDataResultRequest): Promise<GetComputeToDataResultResponse> {
    ...
    return promise.then((data) => GetComputeToDataResultResponse.decode(new BinaryReader(data)));
  }
}
